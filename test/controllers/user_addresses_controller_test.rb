  ...
  test 'should create user_address' do
    assert_difference('UserAddress.count') do
      post user_addresses_url,
           params: { user_address: { address: @user_address.address, city: @user_address.city, landmark: @user_address.landmark,
                                     pincode: @user_address.pincode, state: @user_address.state } }
    end
